...
import { SlidersHorizontal, Timer, Users, Zap } from "lucide-react"; // FORK: custom-properties (SlidersHorizontal)
// plane imports
...
export const PROJECT_SETTINGS_ICONS: Record<TProjectSettingsTabs, LucideIcon | React.FC<ISvgIcons>> = {
  ...
  features_custom_properties: SlidersHorizontal, // FORK: custom-properties
